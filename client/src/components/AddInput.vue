...
input:focus ~ .addInput__label {
  color: turquoise;
  text-shadow: 0px 0px 0.1rem turquoise;
}

input:focus ~ .addInput__label,
input:not(:placeholder-shown).addInput:not(:focus) ~ .addInput__label {
  top: -4.5rem;
}

input:not(:placeholder-shown) ~ .addInput__button {
  display: block;
}
